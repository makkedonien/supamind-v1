...
interface MultipleFeedWebsiteUrlsDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSubmit: (urls: string[]) => Promise<void>;
}

const MultipleFeedWebsiteUrlsDialog = ({
  open,
  onOpenChange,
  onSubmit
}: MultipleFeedWebsiteUrlsDialogProps) => {
...
export default MultipleFeedWebsiteUrlsDialog; 